/*
 * Loan.js
 * Based on Accrue.js by James Pederson
 * Author: Stephen Bodey
 * Version: 1.0.0
 */
    ...
    var calculateAmortization = function( elem, options, output_elem ){
        ...
        if ( loan_info!==0 ) {
            ...
            var output_content = '<table class="accrue-amortization">'+
                    '<thead><tr>'+
                    '<th class="accrue-payment-number">Loan Duration</th>'+
					'<th class="accrue-balance">Balance<span>(Interest)</span></th>'+
                    '</tr></thead><tbody>',
                interest_per_payment = loan_info.original_amount / 100 * 4 / 12 ,
            ...
            for ( var i=0; i<counter_balance; i++) { 

                // Record the payment in our counter variables.
				interest_per_payment = counter_balance / 100 * 4 / 12;
				amount_from_balance = loan_info.payment_amount-interest_per_payment,
                ...
                output_content = output_content+ 
					...
					'<'+cell_tag+' class="accrue-balance">&pound;'+formatNumber(counter_balance.toFixed(2))+'<span>(&pound;'+formatNumber(interest_per_payment.toFixed(2))+')</span></'+cell_tag+'>'+
                    '</tr>';
            }
